...
1. The app performs a patient-dependent subscription specific for reports by specifying a list of possible classCodes and considering creation and update of documents.([ITI-110] Resource Subscription).
