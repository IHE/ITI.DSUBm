...
##### 2:3.111.5.1.1 DocumentReference Subscription for Minimal Update option Trigger Events

When the Resource Notification Publisher supports the [DocumentReference Subscription for Minimal Update option](volume-1.html#15421-updates), in addition to the basic events, events that could trigger this message also are:
...
##### 2:3.111.5.1.2 DocumentReference Subscription for Full Events option Trigger Events

When the Resource Notification Publisher supports the [DocumentReference Subscription for Full Events option](volume-1.html#15421-updates-to-doc), in addition to the basic events, events that could trigger this message also are:
- update of a DocumentReference Resource,
- deletion of a DocumentReference Resource.

Note that also these events could be determined by DocumentEntry Objects events in an XDS environment.

##### 2:3.111.5.1.3 Basic Folder Subscription option Trigger Events

When the Resource Notification Publisher supports the [Basic Folder Subscription option](volume-1.html#15421-updates-to), in addition to the basic events, events that could trigger this message also are:
...
##### 2:3.111.5.1.4 Folder Subscription for Minimal Update option Trigger Events

When the Resource Notification Publisher supports the [Folder Subscription for Minimal Update option](volume-1.html#15421-updates-to-n), in addition to the basic events, events that could trigger this message also are:
- creation of a Folder type List Resource,
- update of a Folder type List Resource to insert a new document in the Folder,
- update of a Folder type List Resource to remove a document from the Folder,
- update of a Folder type List Resource to update the "status".

Note that also these events could be determined by Folder and Association Objects events in an XDS environment.

##### 2:3.111.5.1.5 Folder Subscription for Update option Trigger Events

When the Resource Notification Publisher supports the [Folder Subscription for Update option](volume-1.html#15421-upd-resources-option), in addition to the basic events, events that could trigger this message also are:
- creation of a Folder type List Resource,
- update of a Folder type List Resource.

Note that also these events could be determined by Folder and Association Objects events in an XDS environment.

##### 2:3.111.5.1.6 Folder Subscription for Full Events option Trigger Events

When the Resource Notification Publisher supports the [Updates to document sharing resources option](volume-1.html#15421-updates-to-document-sharing-resources-option), in addition to the basic events, events that could trigger this message also are:
- creation of a Folder type List Resource,
- update of a Folder type List Resource,
...
##### 2:3.111.5.2.1 DocumentReference Subscription for Minimal Update option Bundle

When supported the [DocumentReference Subscription for Minimal Update option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [DocumentReference Subscription for Minimal Update Trigger Events](#23111511-updates) shall have the following constraints:
...
##### 2:3.111.5.2.2 DocumentReference Subscription for Full Events option Bundle

When supported the [DocumentReference Subscription for Full Events option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [DocumentReference Subscription for Full Events option Trigger Events](#23111511-updates) shall be the [Extended Publishing Bundle](StructureDefinition-IHE.DSUBm.ResourceBundle.html).

##### 2:3.111.5.2.3 Subscription with Basic Folder Subscription option Bundle

When supported the [Subscription with Basic Folder Subscription option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [Subscription with Basic Folder Subscription option Trigger Events](#23111511-updates) shall be conform to the [Minimal Metadata Bundle](https://profiles.ihe.net/ITI/MHD/StructureDefinition-IHE.MHD.Minimal.ProvideBundle.html) of Provide Document Bundle [ITI-65] transaction of [MHD](https://profiles.ihe.net/ITI/MHD/index.html) profile.

##### 2:3.111.5.2.4 Folder Subscription for Minimal Update option Bundle

When supported the [Folder Subscription for Minimal Update option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [Folder Subscription for Minimal Update option Trigger Events](#23111511-updates) shall be conform to the [Minimal Metadata Bundle](https://profiles.ihe.net/ITI/MHD/StructureDefinition-IHE.MHD.Minimal.ProvideBundle.html) of Provide Document Bundle [ITI-65] transaction of [MHD](https://profiles.ihe.net/ITI/MHD/index.html) profile.

##### 2:3.111.5.2.5 Folder Subscription for Update option Bundle

When supported the [Folder Subscription for Update option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [Folder Subscription for Update option Trigger Events](#23111511-updates) shall be conform to the [Minimal Metadata Bundle](https://profiles.ihe.net/ITI/MHD/StructureDefinition-IHE.MHD.Minimal.ProvideBundle.html) of Provide Document Bundle [ITI-65] transaction of [MHD](https://profiles.ihe.net/ITI/MHD/index.html) profile.

##### 2:3.111.5.2.6 Folder Subscription for Full Events option Bundle

When supported the [Folder Subscription for Full Events option](volume-1.html#15421-updates-to-document-shn) the FHIR Bundle that shall be used for transmitting the [Folder Subscription for Full Events option Trigger Events](#23111511-updates) shall be the [Extended Publishing Bundle](StructureDefinition-IHE.DSUBm.ResourceBundle.html). 
