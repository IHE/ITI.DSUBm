...
The FHIR Bundle shall have the following constrains:
 ...
 - [Publishing Bundle](StructureDefinition-IHE.DSUBm.Minimal.FolderR4.html)<!--link-->:
    ...
    - shall create a [SubmissionSet type List](StructureDefinition-IHE.DSUBm.Minimal.SubmissionSetR4.html)<!--link-->
    - may create one or more [DocumentReference](StructureDefinition-IHE.DSUBm.Minimal.DocumentReferenceR4.html)<!--link-->
    - may create one or more [Folder type List](StructureDefinition-IHE.DSUBm.Minimal.FolderR4.html)<!--link-->
    - may create one [Patient](https://hl7.org/fhir/R4/patient.html) <!--link-->
