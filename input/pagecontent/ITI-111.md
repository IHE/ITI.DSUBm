...
For the basic events, the FHIR Bundle shall conform to the [Minimal Metadata Bundle](https://profiles.ihe.net/ITI/MHD/StructureDefinition-IHE.MHD.Minimal.ProvideBundle.html) of Provide Document Bundle [ITI-65] transaction of [MHD](https://profiles.ihe.net/ITI/MHD/index.html) Profile.
...
#### 2:3.111.4.3 CapabilityStatement Resource
...
### 2:3.111.5 Security Considerations
...
#### 2:3.111.5.1 Security Audit Considerations
