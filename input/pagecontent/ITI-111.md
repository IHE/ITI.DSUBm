...
The referenced resources generally are hosted on a commonly accessible server. If they are not be accessible by the Resource Notification Broker for the proper evaluation, they shall be included in the Bundle.
