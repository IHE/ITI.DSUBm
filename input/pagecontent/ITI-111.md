...
When the Resource Notification Publisher support the Updating events option, in addition to the privious events, events that could trigger this message also are:
