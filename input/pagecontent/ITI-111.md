...
When the Resource Notification Publisher support the [Updates to document sharing resources option](volume-1.html#15421-updates-to-document-sharing-resources-option), in addition to the privious events, events that could trigger this message also are:
...
When supported the [Updates to document sharing resources option](volume-1.html#15421-updates-to-document-sharing-resources-option) the FHIR Bundle that shall be used for transmitting the [Updates to document sharing resources option trigger events](#3111511-updates-to-document-sharing-resources-option-trigger-events) shall have the following constrains:
