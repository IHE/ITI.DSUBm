...
The FHIR Bundle shall have the following constrains:
 ...
 - [Publishing Bundle](StructureDefinition-IHE.DSUBm.Minimal.FolderR4.html)<!--link-->:
    ...
    - shall convey a [SubmissionSet type List](StructureDefinition-IHE.DSUBm.Minimal.SubmissionSetR4.html)<!--link-->
    - may convey one or more [DocumentReference](StructureDefinition-IHE.DSUBm.Minimal.DocumentReferenceR4.html)<!--link-->
    - may convey one or more [Folder type List](StructureDefinition-IHE.DSUBm.Minimal.FolderR4.html)<!--link-->
    - may convey one [Patient](https://hl7.org/fhir/R4/patient.html) <!--link-->
