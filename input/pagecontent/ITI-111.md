...
- creation or updating of a Folder type List Resource 
- creation of a SubmissionSet type List Resource.

Note that these events could be determinated by DocumentEntry, Folder, and SubmissionSet Objects events in an XDS enviroment.
