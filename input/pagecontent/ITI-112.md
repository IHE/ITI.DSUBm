This section corresponds to transaction [ITI-112] of the IHE Technical Framework. Transaction [ITI-112] is used by the Client and Server Actors. The go [ITI-112] transaction is used to query and get back results.

### Scope

The Client [ITI-112] transaction passes a go Request from a Client to a Server.
