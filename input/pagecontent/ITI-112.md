...
- [Event Notification]()<!--link-->
    ...
    - in the first entry the [Notification Subscription Status Parameter]()<!--link--> resource;
...
- [Handshake Notification]()<!--link-->
    - the `Bundle.type` element valued `history`;
    - in the first entry the [Handshake Subscription Status Parameter]()<!--link--> resource;
...
- [Heartbeat Notification]()<!--link-->
    - the `Bundle.type` element valued `history`;
    - in the first the first entry the [Heartbeat Subscription Status Parameter]()<!--link--> resource;
    - no other entry shall be present.    
...
- [Subscription Deactivation Notification]()<!--link-->
    - the `Bundle.type` element valued `history`;
    - in the first the first entry the [Deactivation Subscription Status Parameter]()<!--link--> resource;
    - no other entry shall be present.
