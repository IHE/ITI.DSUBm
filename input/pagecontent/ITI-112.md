...
The Resource Notification Recipient returns an HTTP status code appropriate to the processing of the request. If the notification has been received and processed an overall http 200 response is used, if the reception or processing of the notification has failed an overall http 400 response is used.
