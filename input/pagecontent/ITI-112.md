...
- any other resorce may be included by the Resource Notification Broker; in order to include resource that could bo of interest for the Rsource Notification Recipient, the Resource Notification Broker should follow what is define by the Topic of the Subscription for the notification shape. 
