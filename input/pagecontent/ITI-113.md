...
- [Resource Notification Subscriber SubscriptionTopic Query](StructureDefinition-IHE.DSUBm.SubscritionSearch.Audit.Subscriber.html), when a search interaction is performed;
- [Resource Notification Subscriber SubscriptionTopic Read](StructureDefinition-IHE.DSUBm.SubscritionRead.Audit.Subscriber.html), when a read interaction is performed.
...
- [Resource Notification Broker SubscriptionTopic Query](StructureDefinition-IHE.DSUBm.SubscritionSearch.Audit.Broker.html), when a search interaction is performed;
- [Resource Notification Broker SubscriptionTopic Read](StructureDefinition-IHE.DSUBm.SubscritionRead.Audit.Broker.html), when a read interaction is performed.
