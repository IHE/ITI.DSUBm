...
The query parameters allowed, reported in Table 3.113.5.2-1,  are the parameters indicated in the [Search parameters](https://hl7.org/fhir/R4/subscription.html#search) section and also the [search parameter](https://build.fhir.org/ig/HL7/fhir-subscription-backport-ig/artifacts.html#behavior-search-parameters) included in the [Subscription R5 Backport Implementation Guide](http://hl7.org/fhir/uv/subscriptions-backport/STU1.1/).  
