...
### 2:3.113.6 Subscription Search Response Message
...
### 2:3.113.7 Subscription Status Search Request Message

The Resource Notification Subscriber Request Message is a parametrized `HTTP GET` that allows to search or retrieve, from the Resource Notification Broker, information about the status of the Subscriptions.
...
### 2:3.113.8 Subscription Status Search Response Message
...
### 2:3.113.9 Subscription Events Search Request Message
...
The Resource Notification Subscriber Request Message shall be a FHIR operation request as defined in FHIR (http://hl7.org/fhir/operations.html) with the $events operation definition and the input parameters in Table 3.113.7.2-1, in order to be aware of previous events related to a Subscription.
