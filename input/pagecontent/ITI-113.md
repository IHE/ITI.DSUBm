This section corresponds to transaction [ITI-113] of the IHE Technical Framework. Transaction [ITI-113] is used by the Client and Server Actors. The go [ITI-113] transaction is used to query and get back results.

### Scope

The Client [ITI-113] transaction passes a go Request from a Client to a Server.
