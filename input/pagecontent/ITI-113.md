...
### 3.113.5 Subscription Search Request Message
...
**Table 3.113.5.2-1: Subscription Search Request Message Search Parameters**
...
##### 3.113.5.2.1 Subscription Search Request Message examples
...
### 3.113.6 Subscription Status Search Request Message
...
**Table 3.113.6.2-1: Subscription Status Search Request Message Parameters**
...
### 3.113.7 Subscription Events Search Request Message
...
**Table 3.113.7.2-1: Subscription Events Search Request Message Parameters**
...
### 3.113.8 Subscription Search Response Message
...
#### 3.113.9.3 Expected Actions
The Resource Notification Subscriber shall process the results according to application-defined rules.



### 3.113.10 Subscription Events Search Response Message
