...
The Resource Notification Broker who received the message SHALL retrieve the Subscription record indicated by the Resource identifier on the HTTP GET supplied by the Resource Notification Subscriber.
