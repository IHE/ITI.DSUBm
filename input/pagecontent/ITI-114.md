...
If the Resource Notification Broker supports the [DocumentReference Subscription for Minimal Update option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:
...
If the Resource Notification Broker supports the [DocumentReference Subscription for Full Events option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:
...
If the Resource Notification Broker supports the [Basic Folder Subscription option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:

- Basic Folder SubscriptionTopic

If the Resource Notification Broker supports the [Folder Subscription for Minimal Update option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:

- Folder SubscriptionTopic with Folder Subscription for Minimal Update option

If the Resource Notification Broker supports the [Folder Subscription for Update option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:

- Folder SubscriptionTopic with Folder Subscription for Update option

If the Resource Notification Broker supports the [Folder Subscription for Full Events option](volume-1.html#15421-updates-to--option), the following SubscriptionTopic resources shall also be present in the response, if parameters match:
