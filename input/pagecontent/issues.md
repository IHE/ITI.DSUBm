...
* **DSUBm_006**: issue su valueset rotto negli artefatti

* **DSUBm_007**: open issue sulla option ?

* **DSUBm_008**: The DSUBm profile propose notifications in a push mechanism. The [Extensions to the Document Metadata Subscription (DSUB)](https://www.ihe.net/uploadedFiles/Documents/ITI/IHE_ITI_Suppl_DSUB_Extensions.pdf)
