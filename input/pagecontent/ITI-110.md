...
- Depending on the type of the Subscription, the AdHocQuery/@id attribute and the the Filters parameter of the Document Metadata Subscribe [ITI-52] transaction shall be set as follows:
  ...
  |-------------------+--------------+------------|
  | Patient-Dependent DocumentReference Subscriptions  | `urn:uuid:aa2332d0-f8fe-11e0-be50-0800200c9a66` | Mapping based on [Table 3:110.4.6-1](#table-docRef) |
  | Multi-Patient DocumentReference Subscriptions | `urn:uuid:742790e0-aba6-43d6-9f1fe43ed9790b79` | Mapping based on [Table 3:110.4.6-1](#table-docRef) |
  | Patient-Dependent SubmissionSet Subscriptions  | `urn:uuid:fbede94e-dbdc-4f6b-bc1f-d730e677cece`| Mapping based on [Table 3:110.4.6-2](#table-submiss)|
  | Multi-Patient SubmissionSet Subscriptions| `urn:uuid:868cad3d-ec09-4565-b66c-1be10d034399`|Mapping based on [Table 3:110.4.6-2](#table-submiss) |
  | Basic Folder Subscriptions | `urn:uuid:9376254e-da05-41f5-9af3-ac56d63d8ebd`|Mapping based on [Table 3:110.4.6-3](#table-folder) |
  {: .grid}
...
#### 2:3.110.4.5 Subscription Topic and Filter Expressions
...
##### 2:3.110.4.5.1 Patient-Dependent DocumentReference Subscription Topic
...
###### 2:3.110.4.5.1.1 Patient-Dependent DocumentReference Subscription Subscription with DocumentReference Subscription for Minimal Update option Topic
...
###### 2:3.110.4.5.1.2 Patient-Dependent DocumentReference Subscription Subscription with DocumentReference Subscription for Full Events option Topic
...
##### 2:3.110.4.5.2 Multi-Patient DocumentReference Subscriptions Topic
...
###### 2:3.110.4.5.2.1 Multi-Patient DocumentReference Subscription Subscription with DocumentReference Subscription for Minimal Update option Topic
...
###### 2:3.110.4.5.2.2 Multi-Patient DocumentReference Subscription Subscription with DocumentReference Subscription for Full Events option Topic
...
##### 2:3.110.4.5.3 Patient-Dependent SubmissionSet Subscription Topic
...
##### 2:3.110.4.5.4 Multi-Patient SubmissionSet Subscription Topic
...
##### 2:3.110.4.5.5 Basic Folder Subscription Topic
...
###### 2:3.110.4.5.5.1 Folder Subscription with Folder Subscription for Minimal Update option Topic
...
###### 2:3.110.4.5.5.2 Folder Subscription with Folder Subscription for Update option Topic
...
###### 2:3.110.4.5.5.3 Folder Subscription with Folder Subscription for Full Events option Topic
...
#### 2:3.110.4.6 Mapping between DSUBm Criteria and DSUB subscription Filters. 
...
**Table 2:3.110.4.6-1: DSUBm DocumentReference subscription criteria mapping to DSUB DocumentEntry Filters**
...
**Table 2:3.110.4.6-2: DSUBm SubmissionSet subscription criteria mapping to DSUB DocumentEntry Filters**
...
**Table 2:3.110.4.6-3: DSUBm Folder subscription criteria mapping to DSUB DocumentEntry Filters**
...
#### 2:3.110.4.7 CapabilityStatement Resource
