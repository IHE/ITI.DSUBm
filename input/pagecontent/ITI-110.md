...
<figcaption><b>Figure 2:3.110.4-1: ITI-110 interactions</b></figcaption>
</figure>
<br clear="all">
...
This profile defines the following types of Subscriptions with relative Subscription Topic:
  ...
  |-------------------+----------------|
  | [Patient-Dependent DocumentReference Subscriptions]()  |[Patient-Dependent DocumentReference Subscription Topic](#2311081-patient-dependent-documentreference-subscription-topic) |
  | [Multi-Patient DocumentReference Subscription]() |[Multi-Patient DocumentReference Subscriptions Topic](#2311082-multi-patient-documentreference-subscriptions-topic)|
  | [Patient-Dependent Folder Subscriptions]() |[Patient-Dependent Folder Subscription Topic](#2311083-patient-dependent-folder-subscription-topic) |
  | [Patient-Dependent SubmissionSet Subscriptions]()  | [Patient-Dependent SubmissionSet Subscription Topic](#2311084-patient-dependent-submissionset-subscription-topic) |
  | [Multi-Patient SubmissionSet Subscriptions]() |[Multi-Patient SubmissionSet Subscription Topic](#2311085-multi-patient-submissionset-subscription-topic) |
  {: .grid}
...
When supported the Updating events option, this profile defines also the following types of Subscriptions with relative Subscription Topic:
  ...
  | Subscription type | Subscription Topic |
  |-------------------+----------------|
  | [Patient-Dependent DocumentReference Subscriptions with updates to document sharing resources option]()  |[Patient-Dependent DocumentReference SubscriptionTopic with updates to document sharing resources option to document sharing resources option](SubscriptionTopic-SubscriptionTopic-DocReference-MultiPatient-All-Interaction.html) |
  | [Multi-Patient DocumentReference Subscription with updates to document sharing resources option]() |[Multi-Patient DocumentReference SubscriptionTopic with Updates to document sharing resources option](SubscriptionTopic-SubscriptionTopic-DocReference-MultiPatient-All-Interaction.html)|
  | [Patient-Dependent Folder Subscription with Updates to document sharing resources option]() |[Patient-Dependent Folder SubscriptionTopic with Updates to document sharing resources option](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-PatientDependent-update.html) |
  {: .grid}
...
A canonical instances of this Subscription Topic is reported here: [Patient-Dependent DocumentReference Subscription Topic](StructureDefinition-DSUBm-DocumentReference-MultiPatient-Subscription-update.html).
...
When supported the Updating events option, this Subscription Topic extends the [Patient-Dependent DocumentReference Subscription Topic](SubscriptionTopic-SubscriptionTopic-DocReference-PatientDependent-All-Interaction.html) in this way:
...
A canonical instances of this Subscription Topic is reported here: [Patient-Dependent DocumentReference Subscription Subscription with Updates to document sharing resources option Topic](StructureDefinition-DSUBm-DocumentReference-MultiPatient-Subscription-update.html).
...
When the [Updates to document sharing resources option](volume-1.html#15421-updates-to-document-sharing-resources-option) is supported, the following Subscription Topic extends the [Multi-Patient DocumentReference Subscriptions Topic](SubscriptionTopic-DSUBm-SubscriptionTopic-DocumentReference-MultiPatient.html) in this way:
...
A canonical instances of this extended Subscription Topic is reported here: [Multi-Patient DocumentReference Subscription Subscription with Updates to document sharing resources option Topic](SubscriptionTopic-SubscriptionTopic-DocReference-MultiPatient-All-Interaction.html).
...
A canonical instances of this Subscription Topic is reported here: [Patient-Dependent Folder Subscription Topic](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-PatientDependent.html).

#### 2:3.110.8.3.1 Patient-Dependent Folder Subscription Subscription with Updates to document sharing resources option Topic

When the [Updates to document sharing resources option](volume-1.html#15421-updates-to-document-sharing-resources-option) is supported, this Subscription Topic extends the [Patient-Dependent Folder Subscription Topic](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-PatientDependent.html) in this way:
...
A canonical instances of this Subscription Topic are reported here: [Patient-Dependent Folder Subscription Subscription with Updates to document sharing resources option Topic](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-PatientDependent-update.html).
...
A canonical instances of this Subscription Topic is reported here: [Patient-Dependent SubmissionSet Subscription Topic](SubscriptionTopic-DSUBm-SubscriptionTopic-SubmissionSet-MultiPatient.html).
