...
- in case of re-activation of an already existing subscription, follow the Expected Actions which are reported in Section [2:3.110.4.1.3 Expected Actions](#2311053-expected-actions).
