...
This profile defines the following types of Subscriptions with related SubscriptionTopic, which the Resource Notification Broker shall support and at least one of them the Resource Notification Subscriber shall support:
  ...
  |-------------------+----------------|
  | [Patient-Dependent DocumentReference Subscriptions](StructureDefinition-DSUBm-DocumentReference-PatientDependent-Subscription.html)  |[Patient-Dependent DocumentReference SubscriptionTopic](#2311091-patient-dependen) |
  | [Multi-Patient DocumentReference Subscriptions](StructureDefinition-DSUBm-DocumentReference-MultiPatient-Subscription.html) |[Multi-Patient DocumentReference SubscriptionsTopic](#2311092-multi-pati)|
  | [Patient-Dependent SubmissionSet Subscriptions](StructureDefinition-DSUBm-SubmissionSet-PatientDependent-Subscription.html)  | [Patient-Dependent SubmissionSet SubscriptionTopic](#2311094-patient-dep) |
  | [Multi-Patient SubmissionSet Subscriptions](StructureDefinition-DSUBm-SubmissionSet-MultiPatient-Subscription.html) |[Multi-Patient SubmissionSet SubscriptionTopic](#2311095-multi-pat) |
  {: .grid}
...
When supporting the DocumentReference Subscription for Minimal Update option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | Subscription type | SubscriptionTopic |
  |-------------------+----------------|
  | [Patient-Dependent DocumentReference Subscriptions with DocumentReference Subscription for Minimal Update option](StructureDefinition-DSUBm-DocumentReference-PatientDependent-Subscription-update.html)  |[Patient-Dependent DocumentReference SubscriptionTopic with DocumentReference Subscription for Minimal Update option](#23110911-patient-dependent-documentrefer) |
  | [Multi-Patient DocumentReference Subscription DocumentReference Subscription for Minimal Update option](StructureDefinition-DSUBm-DocumeniPatient-Subscription-update.html) |[Multi-Patient DocumentReference SubscriptionTopic with DocumentReference Subscription for Minimal Update option](#23110921-multi-patient-documentreference-suic)|
  {: .grid}
...
When supporting the DocumentReference Subscription for Full Events option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | Subscription type | SubscriptionTopic |
  |-------------------+----------------|
  | [Patient-Dependent DocumentReference Subscriptions with DocumentReference Subscription for Full Events option](StructureDefinition-DSUBm-DocumentRefe.html)  |[Patient-Dependent DocumentReference SubscriptionTopic with DocumentReference Subscription for Full Events option](#23110911-patient-dependent-documentrerces-option-topic) |
  | [Multi-Patient DocumentReference Subscription with DocumentReference Subscription for Full Events option](StructureDefinition-DSUBm-DocumentReference.html) |[Multi-Patient DocumentReference SubscriptionTopic with DocumentReference Subscription for Full Events option](#23110921-multi-patient-documentrefere)
...
When supporting the Basic Folder Subscription option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | [Basic Folder Subscriptions](StructureDefinition-DSUBm-Folder-Patienton.html) |[Basic Folder SubscriptionTopic](#2311093-patient-dependent-folder-ption-topic) |
...
When supporting the Folder Subscription for Minimal Update option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | [Folder Subscriptions with Folder Subscription for Minimal Update option](StructureDefinition-DSUBm-Folder-Patientndent-Subscription.html) |[Folder SubscriptionTopic with Folder Subscription for Minimal Update option](#2311093-patient-ion-topic) |
...
When supporting the Folder Subscription for Update option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | [Folder Subscriptions with Folder Subscription for Update option](StructureDefinition-DSUBm-Folder-Patientndent-Subscription.html) |[Folder SubscriptionTopic with Folder Subscription for Update option](#2311093-patient-ion-topic) |
...
When supporting the Folder Subscription for Full Events option, this profile also defines the following types of Subscriptions with related SubscriptionTopic:
  ...
  | [Folder Subscriptions with Folder Subscription for Full Events option](StructureDefinition-DSUBm-Folder-Patientndent-Subscription.html) |[Folder SubscriptionTopic with Folder Subscription for Full Events option](#2311093-patient-ion-topic) |
...
When supporting the [DocumentReference Subscription for Minimal Update option](#shdi), this Subscription Topic extends the [Patient-Dependent DocumentReference SubscriptionTopic](#2311091-patient-dependent-documentreference-subscription-topic) in this way:
...
The canonical URL of this SubscriptionTopic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-bla`.

The canonical instance of this SubscriptionTopic is reported here: [Patient-Dependent DocumentReference SubscriptionTopic with DocumentReference Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopic-bla.html).
...
When supporting the [DocumentReference Subscription for Full Events option](#sdds), this Subscription Topic extends the [Patient-Dependent DocumentReference SubscriptionTopic](#2311091-patient-dependent-documentreference-subscription-topic) in this way:
...
The canonical URL of this SubscriptionTopic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-blabla`.

The canonical instance of this SubscriptionTopic is reported here: [Patient-Dependent DocumentReference SubscriptionTopic with Updates to document sharing resources option](SubscriptionTopic-DSUBm-SubscriptionTopic-blabla.html).
...
When the [DocumentReference Subscription for Minimal Update option](volume-1.html#15421-up) is supported, the following Subscription Topic extends the [Multi-Patient DocumentReference Subscriptions Topic](#2311092-multi-patient-documentreference-subscriptions-topic) in this way:

- the stream of events for which subscriptions are possible also **includes** events representing **only the update of the "status" and the deletion** of DocumentReference Resources related to Documents. Note that these events could be determined by Document Entry Objects updated or deleted in an XDS environment.

The canonical URL of this SubscriptionTopic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-SubscriptionTopic-bla`.

The canonical instance of this extended SubscriptionTopic is reported here: [Multi-Patient DocumentReference SubscriptioTopic with DocumentReference Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopic-blabla.html).
...
When the [DocumentReference Subscription for Full Events option](volume-1.html#15421-up) is supported, the following Subscription Topic extends the [Multi-Patient DocumentReference Subscriptions Topic](#2311092-multi-patient-documentreference-subscriptions-topic) in this way:

- the stream of events for which subscriptions are possible also **includes** events representing **the update and the deletion** of DocumentReference Resources related to Documents. Note that these events could be determined by Document Entry Objects updated or deleted in an XDS environment.

The canonical URL of this SubscriptionTopic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-bla`.

The canonical instance of this extended SubscriptionTopic is reported here: [Multi-Patient DocumentReference SubscriptioTopic with DocumentReference Subscription for Full Events option](SubscriptionTopic-DSUBm-SubscriptionTopic-bla.html).
...
When the [Basic Folder Subscription option](volume-1.html#15421-updates-to) is supported, this type of subscription is admitted. For this type of subscription, the stream of events for which subscriptions are possible is limited to events representing **the creation of Folder type List Resources and the update to insert new documents in Folder**. Note that these events could be determined from Folder Objects created or updated and Association Object creation in an XDS environment. Note that these creation or updating events could happen with other events.
...
The canonical URL of this SubscriptionTopic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-Folder-Pascription`.
...
The canonical instance of this SubscriptionTopic is reported here: [Basic Folder SubscriptionTopic](SubscriptionTopic-DSUBm-Subscriendent.html).

##### 2:3.110.9.5.1 Folder Subscription with Folder Subscription for Minimal Update option Topic

When the [Updates to document sharing resources option](volume-1.html#15421-updates-to) is supported, this Subscription Topic extends the [Basic Folder Subscription Topic](#2311093-patient-depend) in this way:
...
The canonical URL of this Subscription Topic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-SubscriptionTo`.

The canonical instance of this SubscriptionTopic is reported here: [Folder Subscription with Folder Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopi.html).

##### 2:3.110.9.5.2 Folder Subscription with Folder Subscription for Update option Topic

When the [Folder Subscription for Update option](volume-1.html#15421-updates-to) is supported, this Subscription Topic extends the [Basic Folder Subscription Topic](#2311093-patient-depend) in this way:
...
When the [Folder Subscription for Full Events option](volume-1.html#15421-updates-to) is supported, this Subscription Topic extends the [Basic Folder Subscription Topic](#2311093-patient-depend) in this way:

- the stream of events for which subscriptions are possible **includes** also events representing **all the updates and the deletion** of Folder type List Resources related to Folders. Note that these events could be determined from Folder Objects update or deletiona or Association Objects creation, update or delete in an XDS environment.

The canonical URL of this Subscription Topic that shall be used in the `Subscription.criteria` element is `https://profiles.ihe.net/ITI/DSUBm/DSUBm-SubscriptionTo`.

The canonical instance of this SubscriptionTopic is reported here: [Folder Subscription with Folder Subscription for Full Events option option](SubscriptionTopic-DSUBm-SubscriptionTopi.html).
...
**Table 2:3.110.10-2: DSUBm SubmissionSet susbcription criteria mapping to DSUB DocumentEntry Filters**
...
**Table 2:3.110.10-3: DSUBm Folder susbcription criteria mapping to DSUB DocumentEntry Filters**
