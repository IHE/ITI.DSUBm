...
<table border="1" borderspacing="0" style='border: 1px solid black; border-collapse: collapse'>
  <tr>
    ...
    <td>
    <li>the <code class=" highlighter-rouge language-plaintext">Subscription.criteria</code> element shall be valued <code class=" highlighter-rouge language-plaintext">urn:uuid:aa2332d0-f8fe-11e0-be50-0800200c9a66</code> that is the canonical URL for the <a href="#Patient-Dependent DocumentReference Subscription Topic">Patient-Dependent DocumentReference Subscription Topic</a></li>
  ...
  <tr>
    ...
    <td>
    <li>the <code class=" highlighter-rouge language-plaintext">Subscription.criteria</code> element shall be valued <code class=" highlighter-rouge language-plaintext">urn:uuid:742790e0-aba6-43d6-9f1fe43ed9790b79</code> that is the canonical URL for the <a href="#Multi-Patient DocumentReference Subscriptions Topic">Multi-Patient DocumentReference Subscriptions Topic</a></li>
  ...
  <tr>
    ...
    <td>
    <li>the <code class=" highlighter-rouge language-plaintext">Subscription.criteria</code> element shall be valued <code class=" highlighter-rouge language-plaintext">urn:uuid:9376254e-da05-41f5-9af3-ac56d63d8ebd</code> that is the canonical URL for the <a href="#Patient-Dependent Folder Subscriptions Topic">Patient-Dependent Folder Subscriptions Topic</a></li>
  ...
  <tr>
    ...
    <td>
    <li>the <code class=" highlighter-rouge language-plaintext">Subscription.criteria</code> element shall be valued <code class=" highlighter-rouge language-plaintext">urn:uuid:fbede94e-dbdc-4f6b-bc1f-d730e677cece</code> that is the canonical URL for the <a href="#Patient-Dependent SubmissionSet Subscriptions Topic">Patient-Dependent SubmissionSet Subscriptions Topic</a></li>
  ...
  <tr>
    ...
    <td>
    <li>the <code class=" highlighter-rouge language-plaintext">Subscription.criteria</code> element shall be valued <code class=" highlighter-rouge language-plaintext">urn:uuid:868cad3d-ec09-4565-b66c-1be10d034399</code> that is the canonical URL for the <a href="#Multi-Patient SubmissionSet Subscriptions Topic">Multi-Patient SubmissionSet Subscriptions Topic</a></li>
