...
The canonical instance of this extended SubscriptionTopic is reported here: [Multi-Patient DocumentReference SubscriptioTopic with DocumentReference Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopic-DocReference-MultiPatient-MinUpdate.html).
...
The canonical instance of this extended SubscriptionTopic is reported here: [Multi-Patient DocumentReference SubscriptioTopic with DocumentReference Subscription for Full Events option](SubscriptionTopic-DSUBm-SubscriptionTopic-DocReference-MultiPatient-AllEvents.html).
...
The canonical instance of this SubscriptionTopic is reported here: [Folder Subscription with Folder Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-Subscription-MinUpdateOpt.html).
...
The canonical instance of this SubscriptionTopic is reported here: [Folder Subscription with Folder Subscription for Minimal Update option](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-Subscription-UpdateOpt.html).
...
The canonical instance of this SubscriptionTopic is reported here: [Folder Subscription with Folder Subscription for Full Events option option](SubscriptionTopic-DSUBm-SubscriptionTopic-Folder-Subscription-for-Full-Events.html).
