...
The Subscription resource shall have channel.type = "rest-hook" and the element channel.endpoint must contain the URL to which is intended to recieve the notification.
