...
InstanceOf: ResourcePublishBundleR4
Title:      "Request message for Resource Publish created from the submission of two documents"
...
InstanceOf: IHE.DSUBm.Minimal.SubmissionSetR4
...
InstanceOf: IHE.DSUBm.Minimal.DocumentReferenceR4
