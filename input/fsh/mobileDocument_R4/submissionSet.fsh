...
Profile:        SubmissionSetR4
Parent:         DSUBmListR4
Id:             IHE.DSUBm.Minimal.SubmissionSetR4
...
* identifier[uniqueId] only SubmissionSetUniqueIdIdentifierR4
* identifier contains entryUUID 0..*
* identifier[entryUUID] only EntryUUIDIdentifierR4
* status = #current
* mode = #working
* title 0..1
* code = DSUBmlistTypesR4#submissionset
* subject 0..1 MS
...
Profile:        SubmissionSetComprehensiveUnContainedR4
Parent:         IHE.DSUBm.Minimal.SubmissionSetR4
Id:             IHE.DSUBm.UnContained.Comprehensive.SubmissionSetR4
...
Profile:        SubmissionSetComprehensiveR4
Parent:         IHE.DSUBm.UnContained.Comprehensive.SubmissionSetR4
Id:             IHE.DSUBm.Comprehensive.SubmissionSetR4
...
// mappings to XDS 
Mapping: SubmissionSet-MappingR4
Source:	IHE.DSUBm.Minimal.SubmissionSetR4
Target: "XDS"
