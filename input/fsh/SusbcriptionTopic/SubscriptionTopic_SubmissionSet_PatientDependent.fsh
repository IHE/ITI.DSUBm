...
Usage: #definition
Title:       "Canonical Topic for a SubmissionSet PatientDependent creation event for a specific patient"
...
This topic shall be used in all SubmissionSet subscriptions that have a specific patient in the criteria element.
Note that:
